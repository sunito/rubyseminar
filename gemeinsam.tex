...
\tikzstyle{klasse} = [rectangle, draw, thin, fill=blue!20, text ragged ]
\tikzstyle{objekt} = [ellipse, draw, thin, fill=green!20, minimum height=2.5em, text ragged]
...
\tikzset{%
    method1/.style={thin,blue,to reversed->}
    }
\tikzset{%
