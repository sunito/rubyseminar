...
\begin{frame}
  \frametitle{Threads}
  \lstinputlisting[frame=single,caption={Kuchen backen}]{code/kuchenbacken.rb}
\end{frame}

\begin{frame}
  \frametitle{Threads}
  \lstinputlisting[frame=single,caption={Kuchen backen Ausgabe}]{code/kuchenbacken_ergebnis}
\end{frame}
...
\begin{frame}
  \frametitle{Threads}
  \lstinputlisting[frame=single,caption={Kuchen backen}]{code/kuchenbacken2.rb}
\end{frame}

\begin{frame}
  \frametitle{Threads}
  Monitors
  \lstinputlisting[frame=single,caption={counter.rb}]{code/counter.rb}
\end{frame}
...
\begin{frame}
  \frametitle{Threads}
  Monitors
  \lstinputlisting[frame=single,caption={counter2.rb}]{code/counter2.rb}
\end{frame}

\begin{frame}
  \frametitle{Threads}
  Monitor nicht als Unterklasse von Monitor
  \lstinputlisting[frame=single,caption={counter3.rb}]{code/counter3.rb}
\end{frame}
